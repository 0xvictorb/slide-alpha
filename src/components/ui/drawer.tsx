		...
		<DrawerPortal>
			...
			<DrawerPrimitive.Content
				...
				className={cn(
					...
					'data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:max-h-[95vh] data-[vaul-drawer-direction=top]:rounded-b-base border-t-2 border-t-border',
					'data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-0 data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-[95vh] data-[vaul-drawer-direction=bottom]:rounded-t-base border-b-2 border-b-border',
				...
				{...props}>
				<div className="mx-auto mt-4 hidden h-1.5 w-[80px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block bg-black/15" />
				{children}
			</DrawerPrimitive.Content>
		</DrawerPortal>
	)
